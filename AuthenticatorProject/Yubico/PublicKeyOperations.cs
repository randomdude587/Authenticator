...
namespace AuthenticatorProject.Yubico {
    ...
    public static class PublicKeyOperations {
        ...
        public static bool SampleVerifySignature(
            ...
            AsymmetricAlgorithm asymObject = KeyConverter.GetDotNetFromPivPublicKey(publicKey);
        ...
        public static bool SampleEncryptRsa(
            ...
            var rsaObject = (RSA) KeyConverter.GetDotNetFromPivPublicKey(publicKey);
        ...
        public static bool SampleKeyAgreeEcc(
            ...
            // get the parameters.
            var ecDsaObject = (ECDsa) KeyConverter.GetDotNetFromPivPublicKey(publicKey);
            ...
            var yubiKeyPublic = ECDiffieHellman.Create(ecParams);

            // This will create a new EC Key pair based on the curve.
            // This is the correspondent's public and private key.
            var correspondentObject = ECDiffieHellman.Create(ecParams.Curve);
